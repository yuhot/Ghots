...
cl = LINE('EzZcSOLi9a7P4mE6Bst4.rYcMdfwzXQP7SCTvAUKP9a.Y5K8riyiwY6mqQZPN93IbHYHAKb5fX0VF1GTec2ZKtQ=')
cl.log("Auth Token : " + str(cl.authToken))
#channel = LineChannel(cl)
#cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LINE('EzCjtCV8gYnPXg06Mned.zKCl/ulo2uMwMI1zPLk5pq.VKUEGBZkaeye1pt2G6EdHtPIwQ5JoD4pCvLubXbDiU4=')
...
#kb.log("Auth Token : " + str(kl.authToken))
#channel4 = LineChannel(kl)
#kb.log("Channel Access Token : " + str(channel4.channelAccessToken))

sw = LINE('EznGNoFk8hK7W4otbP6b.ChkkbvakGOI36QVWfsFGkW.XuKYhHO/cVMG/hzwMBmDkk5FTlPrID2d4SfuHQH1r6M=')
